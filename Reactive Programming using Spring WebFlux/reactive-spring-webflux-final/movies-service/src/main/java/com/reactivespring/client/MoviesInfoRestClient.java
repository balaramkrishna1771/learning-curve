      ...
      return webClient
              ...
              .onStatus(HttpStatus::is4xxClientError, clientResponse -> {
                  ...
                  if(clientResponse.statusCode().equals(HttpStatus.NOT_FOUND)){
                      return Mono.error(new MoviesInfoClientException("There is no MovieInfo" +
                              "available for the given movie" + movieId, clientResponse.statusCode().value()));
                  }
                  return clientResponse.bodyToMono(String.class)
                          .flatMap(responseMessage -> Mono.error(new MoviesInfoClientException("There is no MovieInfo" +
